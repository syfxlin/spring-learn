...
import me.ixk.mybatis_generator.entity.UsersExample.Criteria;
import me.ixk.mybatis_generator.entity.UsersExample.Criterion;
...
public class UsersSqlProvider {
    ...
    public String insertSelective(Users record) {
        ...
        if (record.getEmailVerifiedAt() != null) {
            sql.VALUES("email_verified_at", "#{emailVerifiedAt,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getPassword() != null) {
            sql.VALUES("password", "#{password,jdbcType=LONGVARCHAR}");
        }
     ...
     * @mbg.generated Tue Apr 14 14:52:14 CST 2020
     */
    public String selectByExampleWithBLOBs(UsersExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getEmailVerifiedAt() != null) {
            sql.SET("email_verified_at = #{record.emailVerifiedAt,jdbcType=TIMESTAMP}");
        }
        ...
        if (record.getPassword() != null) {
            sql.SET("password = #{record.password,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Users record) {
        ...
        if (record.getEmailVerifiedAt() != null) {
            sql.SET("email_verified_at = #{emailVerifiedAt,jdbcType=TIMESTAMP}");
        }
        
        if (record.getRememberToken() != null) {
            sql.SET("remember_token = #{rememberToken,jdbcType=VARCHAR}");
        }
        ...
        if (record.getPassword() != null) {
            sql.SET("password = #{password,jdbcType=LONGVARCHAR}");
        }
